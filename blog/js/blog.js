...
function renderArticles() {
  ...
  articles.forEach(article => {
    ...
    articleElement.setAttribute("data-genre", article.genre);
    articleElement.setAttribute("data-age", article.ages);
    articleElement.setAttribute("data-rating", article.stars.length);
